...
$db = new db();
$db->misc("ALTER TABLE `".$glob['dbprefix']."CubeCart_taxes` CHANGE `percent` `percent` DECIMAL( 7, 4 ) NOT NULL DEFAULT '0.0000'");
...
<hr />
<?php 
echo "ALTER TABLE `".$glob['dbprefix']."CubeCart_taxes` CHANGE `percent` `percent` DECIMAL( 7, 4 ) NOT NULL DEFAULT '0.0000'";
?>
<hr />
</p>
<?php
