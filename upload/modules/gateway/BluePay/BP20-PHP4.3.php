 ...
 */
 ...
 define( 'MODE', $moduleMode ); // either TEST or LIVE
 ...
 /*
 define( 'ACCOUNT_ID', '123123123123' ); // the default account id
 define( 'SECRET_KEY', 'ajkdhfalkjfhalsjkhadlfahlkjfh' ); // the default secret key
 */
 define( 'ACCOUNT_ID', $module['accNo'] ); // the default account id
 define( 'SECRET_KEY', $module['key'] ); // the default secret key
 ...
 */
 ...
 'TRANS_TYPE' => $this->transType, //TRANS_TYPE
 'PAYMENT_TYPE' => $this->payType,
 'MODE' => $this->mode,
 'MASTER_ID' => $this->masterId,

 'PAYMENT_ACCOUNT' => $this->account, //PAYMENT_ACCOUNT
 'CARD_CVV2' => $this->cvv2, //CARD_CVV2
 'CARD_EXPIRE' => $this->expire, //CARD_EXPIRE
 'SSN' => $this->ssn,
